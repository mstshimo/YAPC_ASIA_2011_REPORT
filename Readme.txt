...
======================================================
チェックイン
ビールに乾き物のつまみがあり、既にわいわい、がやがや。

==================================================================
超個人情報のためのマルチクラウドを用いた分散セキュアストレージ [ja] [any][tutorial]
Akihiro Nakao
18:00-
==================================================================
id:Piara
...
パスワードを他人のストレージに保存できる？
SpiderOrk

クラウドベンダーを信頼しきるよりEncryptすべき

暗号化支援ブックマークレット「encipher.it」
...
==================================================================
本当は難しいフレンド・タイムライン処理 [ja] [intermediate][app]
kamipo
18:20-
==================================================================
pixiv.incの人
...
FT処理とは
	時系列に並べる処理のこと。ツイッターみたいの。

最新の投稿を素早く表示したい。
一人一人の結果が違うので、効率良くキャッシュするのが難しい

フォロー数が少ない人UIDをkey
フォロー数が多い人プライマリーkey
	インデックスの使い分け

ページ数が多いようなページャーを作るときは考えたほうが良い。
	ページ数を制限する
	真ん中より後ろは、逆順表示
...
==================================================================
TTでもなくXSlateでもなく、HTML::Template(::Pro)を使うとても些細な理由 [ja] [beginner][app]
Seiji OHIRA
19:00-
==================================================================
@s_ohira
...
==================================================================
サービス運用者のための継続的監視 [ja] [intermediate][infra]
Tatsuro Myfinder Hisamori
19:20-
==================================================================
監視すること
	サーバ性能
